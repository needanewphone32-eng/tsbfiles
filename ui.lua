...
-- === Size Selector GUI and Main GUI Wrapper (Appended) ===
-- Note: This section assumes WindUI will be available at runtime (see init below).
local WindUI = WindUI  -- do not override; will be set/loaded in init()

-- Function to create the size selector GUI
local function createSizeSelector()
    local TweenService = game:GetService("TweenService")
    local sizeSelectorGUI = Instance.new("ScreenGui")
    sizeSelectorGUI.Name = "SizeSelector"
    sizeSelectorGUI.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
    sizeSelectorGUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

    -- Main frame (matching WindUI theme)
    local mainFrame = Instance.new("Frame")
    mainFrame.Size = UDim2.new(0, 300, 0, 200)
    mainFrame.Position = UDim2.new(0.5, -150, 0.5, -100)
    mainFrame.BackgroundColor3 = Color3.fromRGB(24, 24, 27) -- Dark theme background
    mainFrame.BorderSizePixel = 0
    mainFrame.Parent = sizeSelectorGUI

    -- Add rounded corners to match WindUI style
    ...
    title.BackgroundColor3 = Color3.fromRGB(36, 36, 40) -- Slightly lighter than main background
    ...
    for _, sizeInfo in ipairs(sizes) do
        ...
        button.BackgroundColor3 = Color3.fromRGB(63, 63, 70) -- Button color matching WindUI
        button.BorderSizePixel = 0
        button.Text = sizeInfo.name
        ...
        button.MouseEnter:Connect(function()
            TweenService:Create(
                button,
                TweenInfo.new(0.2),
                {BackgroundColor3 = Color3.fromRGB(82, 82, 91)}
            ):Play()
        end)
        ...
        button.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(
                button,
                TweenInfo.new(0.1),
                {BackgroundColor3 = Color3.fromRGB(112, 112, 122)}
            ):Play()
            ...
            -- Close selector and open main GUI
            wait(0.2)
            if sizeSelectorGUI and sizeSelectorGUI.Parent then
                sizeSelectorGUI:Destroy()
            end
            createMainGUI(sizeInfo.size)
        end)
    end
    ...
    discordButton.Position = UDim2.new(1, -50, 1, -50)
    ...
    discordButton.MouseEnter:Connect(function()
        TweenService:Create(
            discordButton,
            TweenInfo.new(0.2),
            {BackgroundColor3 = Color3.fromRGB(105, 115, 245)}
        ):Play()
    end)
    ...
    discordButton.MouseButton1Click:Connect(function()
        ...
        -- Open Discord invite (user-provided link)
        pcall(function()
            setclipboard("https://discord.gg/NYJtHJaQ")
...
-- Function to create the main GUI with specified size
local function createMainGUI(size)
    -- Create the main WindUI window with the specified size
    local Window
    if WindUI and type(WindUI.CreateWindow) == "function" then
        ...
        -- Fallback: create a simple placeholder frame if WindUI isn't available at call-time
        local sg = Instance.new("ScreenGui")
        sg.Name = "WindUI_Placeholder"
        sg.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")

        local placeholder = Instance.new("Frame")
        placeholder.Size = size or UDim2.new(0,600,0,400)
        placeholder.Position = UDim2.new(0.5, -(placeholder.Size.X.Offset/2), 0.5, -(placeholder.Size.Y.Offset/2))
        placeholder.AnchorPoint = Vector2.new(0.5,0.5)
        placeholder.BackgroundColor3 = Color3.fromRGB(30,30,30)
        placeholder.Parent = sg

        local label = Instance.new("TextLabel")
        label.Size = UDim2.new(1,0,0,30)
        label.Position = UDim2.new(0,0,0,0)
        label.BackgroundTransparency = 1
        label.Text = "WindUI not loaded - placeholder UI"
    ...
    -- Add your tabs and elements here
    -- Example:
    ...
    -- Add keybind button and Discord button to topbar (if supported)
    if Window.CreateTopbarButton then
        Window:CreateTopbarButton("Keybind", "command", function()
        ...
        Window:CreateTopbarButton("Discord", "discord", function()
            pcall(function()
                setclipboard("https://discord.gg/NYJtHJaQ")
...
-- === Initialization and Integration (Appended) ===
local function init()
    ...
    -- Initialize WindUI (assuming it's available)
    if not WindUI or type(WindUI) ~= "table" then
        -- If WindUI isn't available, try to load it
        local success, result = pcall(function()
            -- Try to load WindUI from various possible locations
            local sources = {
                function() return loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Footagesus/WindUI/main/dist/main.lua"))() end,
                function() return game:GetService("ReplicatedStorage"):FindFirstChild("WindUI") end,
                function() return game:GetService("ServerStorage"):FindFirstChild("WindUI") end,
                function() return game:GetService("Players").LocalPlayer.PlayerScripts:FindFirstChild("WindUI") end
            }

            for _, source in ipairs(sources) do
                local ok, loadedUI = pcall(source)
                if ok and loadedUI then
                    return loadedUI
                end
            end
            error("Could not load WindUI")
        end)
    ...
    if type(createSizeSelector) == "function" then
        createSizeSelector()
    end
end

-- Connect to player added event if player doesn't exist yet
...
-- Optional: Add a way to reopen the size selector if needed
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
    if not gameProcessed and input.KeyCode == Enum.KeyCode.F9 then
        ...
        if playerGui and not playerGui:FindFirstChild("SizeSelector") then
            createSizeSelector()
        end
    end
end)
